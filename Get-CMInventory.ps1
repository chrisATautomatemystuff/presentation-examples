...
$inven = Invoke-Sqlcmd -ServerInstance "<SERVERINSTANCE>" -Database "<DBNAME>" -Query $sqlQuery

$inven | Export-Csv -Path C:\scripts\deviceinventory_$(Get-Date -Format MMddyy).csv -NoTypeInformation